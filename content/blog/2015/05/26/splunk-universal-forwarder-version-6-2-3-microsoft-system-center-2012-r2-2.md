...
9. Click next
10. Click Close
11. Right click on the package and click “Distribute Content” using appropriate options for the environment. **_Do not click deploy_**
...
7. Click Next
8. Name the sequence i.e. _Splunk Configuration Script Vx_
9. Click Next
10. Click Next
11. Click Close
